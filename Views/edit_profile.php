<?php
    ...
    if (isset($_POST["search"])) {
        ...
        if (strlen($parameters) > 1) {
            redirect("edit_profile.php".$parameters);
        } else {
            ...
            if (!empty($_GET["intern_id"])) { ?>
                                    ...
                                    <div class="d-flex my-2">
                                        ...
                                        <div class="dropdown align-center me-2">
                                            ...
                                            <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton1">
                                                ...
                                                if (strlen($parameters) > 1) { ?>
                                                    href="<?= "edit_profile.php".$parameters ?>" <?php
                                                } else { ?>
                                                    href="<?= "edit_profile.php" ?>" <?php
                ...
                <div class="row">
                    <div class="interns"> <?php
                        ...
                        while ($row = $db->fetch()) { ?>
                            <a class="clickable-card" href="edit_profile.php?intern_id=<?= $row["intern_id"] ?>"
                                draggable="false">
